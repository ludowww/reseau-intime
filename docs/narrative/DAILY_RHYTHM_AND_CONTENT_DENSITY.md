...
trop de matière → journée illisible, toutes les routes avancent en même temps.
```

Ce document complète :

```text
DIALOGUE_CONTENT_TEXTURE_RULES.md
J1_J10_REVISED_SCENARIO_PLAN.md
J5_J6_REWRITE_PLAN.md
...
```text
Une journée doit sembler vivante,
...
Elles ne doivent pas toutes être des scènes majeures.

Répartition recommandée :

```text
- 1 photo légère / quotidienne ;
- 1 photo relationnelle ou ludique ;
...
```text
La galerie doit être alimentée régulièrement.
Mais la narration ne doit pas faire comme si chaque photo était une bombe.
```

## Hiérarchie des contenus visuels

Toutes les photos ne doivent pas avoir le même poids.

Niveaux :

```text
1. texture quotidienne ;
2. prétexte de contact ;
3. trace douce ;
4. photo de jeu ;
5. photo de valorisation ;
6. photo preuve faible ;
7. photo défi ;
8. photo conséquence ;
9. photo rare / pivot.
```

Une journée peut contenir plusieurs photos, mais seulement une doit idéalement porter un vrai pivot.

## Présence des personnages

Les personnages peuvent être absents pendant quelques jours.
...
```text
- ne pas faire écrire tout le monde tous les jours ;
- une absence peut être une conséquence ;
- une absence peut créer du manque ;
- un retour après silence doit changer quelque chose ;
- un personnage absent peut être présent indirectement par une photo, une mention ou une conséquence.
```

Exemples :

```text
Sandra absente après une phrase trop forte → manque / prudence.
Raphaëlle absente si Player reste flou → elle ne sert pas de refuge.
Mathilde absente un jour mais présente dans la maison par Marie.
Pauline silencieuse après un défi → elle laisse Player imaginer ce qu’elle garde.
Nico absent mais présent dans une photo sociale de Marie.
```

## Pivot principal / pivot secondaire
...
```text
J5
Conversation 1 : Marie nomme que le couple vacille.
Conversation 2 : Pauline confronte doucement Player.
Conversation 3 : Sandra absente ou courte relance de confidence.
Photos : photo sociale J4/J5, selfie Pauline, photo légère ou souvenir Sandra/Marie.
```
...
Une journée de respiration n’est pas une journée vide.

Elle peut contenir :

```text
- peu de conversations ;
- plus de photos légères ;
- un silence signifiant ;
- un mini-malentendu ;
- une scène domestique ;
- une pause travail ;
- une blague qui prépare une future tension.
```

But : laisser le joueur assimiler.
...
- elle attend une réponse plus claire ;
- son absence crée du manque ou de la jalousie.
```

Une absence ne doit pas être seulement un oubli de production.
...
- une route qui monte ;
- une route qui recule ou attend ;
- une fin de jour avec état lisible.
```
