...
- secrets révélés ;
- secrets restants ;
- niveau d’intimité obtenu ;
- contenus visuels débloqués ;
- dernier message.

## Échelle d’intimité

```text
0 — Aucun rapprochement
1 — Complicité
2 — Ambiguïté
3 — Séduction
4 — Intimité secrète
5 — Intimité explicite / conséquence
```
...
- Pauline : suspecte si elle a provoqué.
- Nico : écarté.

Contenus : contenus intimes de Marie, galerie de réconciliation.

Dernier message possible :

> Marie : Je peux entendre tes désirs. Je ne veux plus découvrir tes secrets.
...
> Marie : Tu ne m’as pas trompée d’un coup. Tu m’as quittée par petits messages.
...
Intimité : Sandra niveau 5, mais rare et tardif.
...
> Sandra : Je suis désolée si je t’ai laissé croire que j’étais plus courageuse que ça.
...
Intimité : Mathilde niveau 5.

Dernier message possible :

> Marie : Tu pouvais me faire du mal avec n’importe qui. Mais pas avec elle.
...
> Mathilde : Je crois qu’on a eu raison. Même si une partie de moi déteste ça.
...
Contenus : galerie Mathilde / Marie, contenus de permission, preuves sensibles.
...
- Sandra/Raphaëlle : généralement routes fermées.

Dernier message possible :

> Marie : Tu voulais ouvrir une porte. Maintenant, il faut accepter que je puisse en ouvrir une aussi.
...
- Sandra : panique si elle craint d’être exposée.

Dernier message possible :

> Pauline : Tu pensais que je jouais. Moi je savais déjà quoi garder.
...
> Raphaëlle : Viens me voir quand tu ne seras plus en train de fuir quelqu’un d’autre.
...
> Nico : Tu la regardais comme une habitude. Moi je l’ai regardée comme une femme.
...
> Marie : Je ne veux pas te remplacer. Je veux que tu comprennes ce que ça me fait d’être désirée.
...
- Marie : rupture ou humiliation.
- Sandra : fuit.
- Raphaëlle : coupe.
- Mathilde : culpabilise ou avoue.
- Pauline : expose ou conserve les preuves.
- Nico : prend de la place auprès de Marie.

Dernier message possible :

> Tu voulais plusieurs secrets. Tu as obtenu plusieurs témoins.
...
- Marie reste centrale si respectée.
- Pauline compatible mais instable.
- Raphaëlle possible si clarté totale.
- Sandra souvent incompatible avec l’exposition.
- Mathilde reste limite rouge.
- Nico peut être symétrie pour Marie.

Dernier message possible :

> Marie : Je peux partager des vérités. Pas des mensonges déguisés en liberté.
...
- Marie : rupture ou vérité douloureuse.
- Sandra : coupée.
- Mathilde : refusée.
- Pauline : refusée.
- Raphaëlle : respect distant.
...
> Le plus dur n’était pas qu’elles ne me choisissent pas. C’était d’admettre que je ne me choisissais jamais.

## Écran d’épilogue recommandé

Chaque fin doit afficher :

1. État amoureux.
2. État des secrets.
3. Galerie obtenue.
4. Dernier message.
5. Indice de rejouabilité éventuel.