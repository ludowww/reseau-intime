# 12 — Contexte d’histoire et timeline

## Objectif

Définir le contexte fixe de l’histoire avant le début du jeu, afin que toutes les routes partent du même monde relationnel.
...
Toutes les routes doivent partager un contexte commun. Les choix du joueur peuvent transformer les relations, mais ne doivent pas réécrire arbitrairement le passé.
...
- la routine ;
- la sécurité ;
- le territoire du couple ;
- l’interdit quand Mathilde est présente ;
- le lieu où une notification peut devenir dangereuse.
...
- Pauline est la meilleure amie de Marie.
- Elle est en couple.
- Elle donne une image sage et stable.
- En réalité, elle trompe déjà son copain.
- Elle sait jouer avec les apparences et les limites.
- Elle organise ou déclenche une soirée pivot.
...
Le vrai espace du jeu.

Toutes les relations passent par lui : messages, stories, photos, vidéos, preuves, suppressions, notifications.

## Timeline du vertical slice
...
- présenter le couple ;
- montrer la tendresse fatiguée ;
- introduire les premières notifications.

Événements possibles :

- Marie écrit pour une chose pratique.
- Sandra envoie un message léger.
- Pauline annonce une soirée.
- Nico est mentionné.
- Raphaëlle existe dans le cadre du travail.

### Jour 2 — Premières tensions

Objectifs :

- faire entrer les personnages dans des canaux privés ;
- installer les premiers écarts.
...
- croiser les tensions ;
- provoquer la première vraie bifurcation ;
- tester les messages simultanés.
...
- transformer une tension en trace ;
- déclencher une route dominante probable.
...
5. Raphaëlle représente la clarté possible.
6. Pauline représente la manipulation sociale et les preuves.
7. Nico représente le miroir jaloux et le désir extérieur envers Marie.
8. Les contenus visuels créent toujours un risque.
9. Les choix peuvent être anodins, mais leur accumulation doit avoir un sens.
10. L’histoire doit rester cohérente même si la route dominante change.

## Ce qui peut varier selon les choix

- Le degré de confiance de Marie.
- La place de Nico auprès de Marie.
- Le degré de désir ou de recul de Mathilde.
- L’attachement ou la fuite de Sandra.
- La clarté ou la coupure de Raphaëlle.
- Le contrôle de Pauline.
- Le mode relationnel : réparation, tromperie, libertinage, polyamour, NTR, harem ou chaos.

## Règle de cohérence

Une route ne doit jamais donner l’impression de sortir de nulle part.

Si une relation bascule, le joueur doit pouvoir relire les scènes précédentes et comprendre quels signaux l’ont préparée.