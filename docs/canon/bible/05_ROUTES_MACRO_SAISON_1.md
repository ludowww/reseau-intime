# Réseau Intime — 05 Routes macro de la saison 1

## Statut du document

**Catégorie : Canon**

**Niveau : Architecture des transformations relationnelles**

Ce document définit les transformations durables que les relations principales peuvent connaître pendant la première saison.
...
# 1. Définition d’une route macro
...
Une route devient lisible après coup.

---

# 2. Ce qui constitue une vraie bascule
...
1. un changement réel de comportement ;
2. une reconnaissance, même partielle, de ce changement ;
3. une nouvelle attente ou limite ;
4. une trace durable ;
...
Une continuité propre apparaît :
...
Une action rend le retour à l’ancienne définition impossible ou artificiel.
