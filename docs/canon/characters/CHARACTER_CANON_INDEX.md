...
| Pauline | `docs/canon/characters/PAULINE_CANON_FULL.md` | Full concrete + NSFW current canon; supersedes calibration-only profile and old J4/J5 route assumptions |
...
```text
PAULINE_CANON_FULL.md overrides old omniscient-photo-controller, constant-halo, playable-vocal, fixed J4/J5, and early-route assumptions.
```
