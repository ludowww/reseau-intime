...
class V084TemporalFlowStaticTests(unittest.TestCase):
    ...
    def test_only_tuesday_is_initially_available_and_seven_day_chain_is_explicit(self):
        indexes = [
            ...
            load_json("data/conversations/chapter_07_modular_index.json"),
        ]
        self.assertEqual(
        ...
        self.assertEqual(indexes[5]["timeline_flow"].get("next_day"), 7)
        self.assertIsNone(indexes[6]["timeline_flow"].get("next_day"))
        ...
        self.assertEqual(indexes[6]["timeline_flow"]["day_start_card"]["eyebrow"], "LUNDI — MATIN")
    ...
    def test_all_active_indexes_define_ordered_timeline_phases(self):
        expected = {
            ...
            "data/conversations/chapter_07_modular_index.json": [
                ("monday_morning_commitment", [], [], []),
                ("monday_sandra_end_shift_candidate", [], ["chapter_07_sandra_end_of_shift"], []),
    ...
    def test_monday_is_final_active_day_after_first_repetition_wave_closure(self):
        ...
        monday = load_json("data/conversations/chapter_07_modular_index.json")
