...
class RuntimeS116J16PlayableStaticTests(unittest.TestCase):
    ...
    def test_state_and_handoff(self):
        ...
        season=self.read("game/scripts/runtime/season_1/Season1RuntimeProvider.gd"); self.assertIn("const SNAPSHOT_VERSION := 21",season); self.assertIn("func _handoff_to_j16",season)
