...
class RuntimeS113J13PlayableStaticTests(unittest.TestCase):
    ...
    def test_handoff_and_placeholders(self):
        ...
        season = self.read("game/scripts/runtime/season_1/Season1RuntimeProvider.gd"); self.assertIn("const SNAPSHOT_VERSION := 17", season); self.assertIn("func _handoff_to_j13", season)
