...
class T(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn("j18_sandra_lunch_print_01",s);self.assertIn("func apply_j18_choice",s);self.assertIn("func _j18_records_consistent",s);self.assertIn("func restore_snapshot",p);self.assertIn("const SNAPSHOT_VERSION := 20",season);self.assertIn('"J18": j18_provider.snapshot()',season)
