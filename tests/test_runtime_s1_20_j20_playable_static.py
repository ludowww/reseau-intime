...
class T(unittest.TestCase):
 def test_contract(self):
  ...
  self.assertIn("func select_j20_context",state);self.assertIn("func select_final_trace_after_j20",state);self.assertIn("fact_nico_friendship_position_defined",state);self.assertIn("func restore_snapshot",provider);self.assertIn("const SNAPSHOT_VERSION := 21",season);self.assertIn('"J20": j20_provider.snapshot()',season)
