...
"${PYTHON_BIN}" -m unittest tests.test_runtime_s1_10_j10_playable_static -v
...
for resolution in 540x960 720x800 720x960 720x1280 1080x1920 1080x2340 1280x720; do
  ...
  "${GODOT_BIN}" "${display_args[@]}" --path "${GODOT_PROJECT_PATH}" --resolution "${resolution}" \
    res://tests/RUNTIME_S1_10J10PlayableSmokeTest.tscn -- "${args[@]}"
done

echo "RUNTIME-S1-10 J10 playable: OK"
