...
5. Donner une conséquence jouable à Mathilde au réveil / nuit chez Marie et Player.
6. Maintenir Marie comme ancrage et désir, pas obstacle.
7. Préserver Sandra rare et émotionnelle, sans nouvelle grosse photo trop rapide.
8. Utiliser Raphaëlle comme clarté calme, pas romance immédiate.
9. Faire de J5 le jour où les images de soirée circulent, changent de sens et créent les premiers risques concrets.
10. Polish galerie/photos placeholders si nécessaire avant d’élargir le casting.
...
- Les dialogues doivent faire sentir par moments la tension et le désir, pas seulement les conséquences.
- Le ton peut évoluer selon les routes : plus tendre, plus ambigu, plus provocant, plus risqué ou plus coupable.
- Les photos restent un moteur d’envie : elles doivent donner envie d’ouvrir, de garder, mais aussi de ne pas se faire prendre.
- Les contenus visuels doivent monter progressivement : social, ambigu, suggestif, puis plus intime plus tard si la route le justifie.
- Un moment de convergence doit donner l’impression que plusieurs possibilités s’ouvrent presque en même temps.
- Pauline doit être renforcée comme miroir dangereux : elle menace les secrets de Player, mais sa propre faute peut aussi laisser des preuves.
- La soirée J4 peut produire plusieurs photos ; J5 doit en redistribuer une partie et laisser sentir que d’autres images existent hors champ.
...
- Ajouter de la complexité structurelle avant d’avoir densifié les tons, les tensions, les photos et les preuves dans le tronc commun.