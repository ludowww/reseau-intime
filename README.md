...
```text
UI‑01  charte verticale et architecture documentaire
UI‑02  spécifications / maquettes des écrans restants
...
# Validation technique historique

Commandes de base à conserver lors de la reprise :
...
Les futurs tests UI devront ajouter les résolutions portrait :
...
Le test `1280 × 720` reste utile tant que l’ancienne interface n’a pas été explicitement retirée.
